...
const TYPE_CONFIG = {
  order_placed:   { color: '#2563eb', bg: '#eff6ff',  label: 'Order' },
  order_shipped:  { color: '#0891b2', bg: '#ecfeff',  label: 'Shipped' },
  order_delivered:{ color: '#16a34a', bg: '#f0fdf4',  label: 'Delivered' },
  order_cancelled:{ color: '#dc2626', bg: '#fef2f2',  label: 'Cancelled' },
  return_update:  { color: '#d97706', bg: '#fffbeb',  label: 'Return' },
